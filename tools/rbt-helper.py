...
WIKI_LINK_MSG = "For more information refer https://parallelmachines.atlassian.net/wiki/display/DEVOPS/Posting+review"
...
def parse_arguments():
    ...
    parser.add_argument('-h', '--help', action='help', default=argparse.SUPPRESS, dest='help',
                        help='This script posts commits as per inputs to review board.'
                             ...
                             'refer : \nhttps://parallelmachines.atlassian.net/wiki/display/DEVOPS/Posting+review')
